 ...
 * @author tayyor
 */
public class CurrentTImeOffset12hr {
    public static void main (String args[]){
        ...
        */
        ...
        // Using the 12hr format;
        currentHrs = Math.abs(currentHrs - 12);
        JOptionPane.showMessageDialog(f,"Current time is: "+currentHrs+":"+currentMinutes+":"+currentSeconds );
    }
